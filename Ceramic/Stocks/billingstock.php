        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                        ...
                        <center>
                            <h3 class="card-title" style="color: white">V Stocks Details</h3>
                        </center>
                    </div>
                    <div class="carr card-body">
                      <form class="row g-3" id="radio-buttons" method="POST" action="billingstock.php">
...
<!--                            <th style="">Total Amount</th> -->
                    ...
                    //  echo "$query";
                      ...
                      if($run->num_rows==0){
                                      echo "<script>Swal.fire({icon: 'error', title: 'Oops...',text: 'No Data Found For Selected Date !!!'});</script>";
...
<!--                         <button id='closebtn' class="btn btn-primary" onclick="location.href = '../admin.php';">Close</button> -->
                    </center>
                </div>
            </div>
         </div>
