<?php
    ...
    $query = "SELECT * FROM subcategories join categories, brandnames, brandmapp where subcategories.category_id = categories.category_id and subcategories.subcategory_id = brandmapp.SubcategoryId and brandmapp.BrandId = brandnames.BrandId and subcategory_id=".$_POST['subcatid'];
    ...
    if($result)
    {
        if($result->num_rows > 0)
        {
            ...
            while($row = $result->fetch_assoc())
            {
                ...
                $obj = array('brandname' => $brand_name, 'brandmapid' => $brand_map_id);
                $dataToBeSent[] = $obj;
            }
