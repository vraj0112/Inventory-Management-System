<?php
    ...
    $query = "SELECT ChallanId, ChallanNo, CustomerName, ChallanDate, challanmst.RecStatus as RecStatus FROM challanmst JOIN tblcustomermst  WHERE challanmst.CustomerId = tblcustomermst.CustomerId and ChallanDate >= '{$fromdate}'and ChallanDate <= '{$todate}' ORDER BY ChallanDate DESC ";
