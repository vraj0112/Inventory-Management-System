    ...
    <script>
        $(function () {
            ...
            $("#searchbtn").click(function () {
                ...
                if ($("#InvoiceNoRadio").prop('checked') == false && $("#customerNameRadio").prop('checked') == false) {
                ...
                if ($("#InvoiceNoRadio").prop('checked') == true) {
                    ...
                    if (invoiceno == "") {
                        swal("Please Enter Invocie No", '', 'info');
                        return;
                    }
            ...
            $("#allinvoicetable tbody").on('click', '.deletebtn', function () {
                ...
                swal({
                    title: "Are You Sure You Want To Delete Challan : " + invoiceno,
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                type: "POST",
                                url: "./SearchAndManageInvoiceAjax/deleteInvoiceId.php",
                                ...
                                error: function (Data) {
                                    console.log("Error In  ./SearchAndManageInvoiceAjax/deleteInvoice.php   Ajax Call");
                                    swal("Something Went Wrong", '', 'error');
                                    return;
                                }
                            });
                    ...
                    $.ajax({
                        ...
                        success: function (Data) {
                            if (Data[0].FLAG == "OKK") {
                                ...
                                swal("Invoice Not Found For Given Challan No.", '', 'warning');
                            }
