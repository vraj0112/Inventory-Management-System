<?php
    ...
    $query = "SELECT InvoiceId, InvoiceNo, CustomerName, InvoiceDate, invoicemst.RecStatus as RecStatus FROM invoicemst JOIN tblcustomermst  WHERE invoicemst.CustomerId = tblcustomermst.CustomerId and invoicemst.CustomerId = {$customerid} and InvoiceDate >= '{$fromdate}'and InvoiceDate <= '{$todate}' ORDER BY InvoiceDate  ";
