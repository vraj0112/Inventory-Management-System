...
<head>
    <title>Search And Manage Customer Return</title>
    <style type="text/css">
        .grid1 {
            display: grid;
            width: '100%';
            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    <div class="card-header" style="background-color: #2B60DE">
                        <center>
                            <h3 class="card-title" style="color: white">Search And Manage Customer Return</h3>
                        </center>
                    </div>
                    <div class="card-body">
                    ...
                    <form action="./SearchAndManageCustomerReturnAjax/viewCustomerReturnByChallanId.php" method="POST" target="_blank"
                        id='openform' hidden>
                        <input type="text" name='challanid' id='openFormChallanId'>
                    </form>
                    <form action="./SearchAndManageCustomerReturnAjax/pdf.php" method="POST" target="_blank" id='pdfform'
                        hidden>
                        <input type="text" name='challanid' id='pdfFormChallanId'>
                    </form>
                    <form action="./SearchAndManageCustomerReturnAjax/editSearchAndManageCustomerReturn.php" method="POST" id='editform' target="_blank"
                        hidden>
    ...
    <script>
        $(function () {
            ...
            function loadCustomerName() {
                $.ajax({
                    type: "POST",
                    url: "./SearchAndManageCustomerReturnAjax/getCustomerNames.php",
                    dataType: 'json',
                    ...
                    error: function (Data) {
                        console.log("Error  ./SearchAndManageCustomerReturnAjax/getCustomerNames.php   Ajax Call");
                    }
                });
            ...
            function searchChallanByOnlyChallanNo(challanno) {
                if (challanno != "") {
                    $.ajax({
                        type: "POST",
                        url: "./SearchAndManageCustomerReturnAjax/getCustomerReturnByOnlyChallanNo.php",
                        ...
                        error: function (Data) {
                            console.log("Err In ./SearchAndManageCustomerReturnAjax/getCustomerReturnByChallanNo.php Ajax Call");
                            swal("Something Went Wrong", '', 'error');
                            return;
                        }
                    });
            ...
            function searchChallanByChallanNo(challanno , fromdate , todate) {
                if (challanno != ""&& fromdate != "" && todate != "") {
                    $.ajax({
                        type: "POST",
                        url: "./SearchAndManageCustomerReturnAjax/getCustomerReturnByChallanNo.php",
            ...
            function serchChallanByOnlyCustomerId(customerid) {
                if (customerid != "-1") {
                    $.ajax({
                        type: "POST",
                        url: "./SearchAndManageCustomerReturnAjax/searchCustomerReturnByOnlyCustomerId.php",
                        ...
                        error: function (Data) {
                            console.log("Err In ./SearchAndManageCustomerReturnAjax/searchCustomerReturnByOnlyCustomerId.php Ajax Call");
                            swal("Something Went Wrong", '', 'error');
                            return;
                        }
                    });
            ...
            function serchChallanByCustomerId(customerid, fromdate, todate) {
                if (customerid != "-1" && fromdate != "" && todate != "") {
                    $.ajax({
                        type: "POST",
                        url: "./SearchAndManageCustomerReturnAjax/searchCustomerReturnByCustomerId.php",
                        ...
                        error: function (Data) {
                            console.log("Err In ./SearchAndManageCustomerReturnAjax/searchCustomerReturnByCustomerId.php Ajax Call");
                            swal("Something Went Wrong", '', 'error');
                            return;
                        }
                    });
            ...
            function serchChallanByDate(fromdate, todate) {
                if (fromdate != "" && todate !="") {
                    $.ajax({
                        type: "POST",
                        url: "./SearchAndManageCustomerReturnAjax/searchCustomerReturnByDate.php",
