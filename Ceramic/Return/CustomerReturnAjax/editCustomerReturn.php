    ...
    <script>
        ...
        $(function () {
            ...
            function ReloadItems() {
                ...
                $.ajax({
                    type: "POST",
                    url: "./ViewCustomerReturnByChallanIdAjax/getPurchasedProductDetails.php",
                        ...
                        if (Data[0].FLAG == "OKK") {
                            ...
                            for (var i = 1; i < n; i++) {
                                ...
                                $("#purchasedtable tbody:last-child").append(
                                    ...
                                    '<td style="width: 50px;"><input type="number" class="form-control availbill" value="0" onkeyup="validateQty(this, ' + billingqty + '); updateTable('+sellingprice+')" step="1" id="billingqty_' + stockid + '"></td>' +
                                    '<td style="width: 50px;"><input type="number" class="form-control availother" value="0" onkeyup="validateQty(this, ' + otherqty + '); updateTable('+sellingprice+')" step="1" id="otherqty_' + stockid + '"></td>' +
            ...
            $("#savebtn").on('click', function(){
                ...
                $.ajax({
                    ...
                    success: function(Data){
                        if(Data == "1"){
                            swal('Succesfully Updated Customer Return', '', 'success').then(()=>{
                                window.close();
                            });
        ...
        function validateQty(ref, avail) {
            ...
            if (enterdvalue < 0) {
                swal('Quantity Cant Be Zero Or Nagetive', '', 'warning').then(() => {
                    ref.value = "";
                    ref.focus();
                    return;
                });
