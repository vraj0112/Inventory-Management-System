<?php
    ...
    $query = "SELECT ChallanId, ChallanDate, CustomerName, challanmst.RecStatus as RecStatus FROM challanmst JOIN tblcustomermst WHERE challanmst.CustomerId = tblcustomermst.CustomerId and challanno='{$challanno}' and ChallanDate >= '{$fromdate}'and ChallanDate <= '{$todate}' ORDER BY ChallanDate";
