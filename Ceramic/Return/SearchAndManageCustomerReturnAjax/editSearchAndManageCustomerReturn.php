                    ...
                    <div class="row mt-1" style="height: 70px; background-color: grey;">
                        ...
                        <table id="purchasedtable">
                            <thead>
                                ...
                                <th>Return<br>Billing<br>Qty</th>
                                <th>Return<br>Other<br>Qty</th>
                                <th width="2.7%"> </th>
    ...
    <script>
        ...
        $(function () {
            ...
            function ReloadItems() {
                ...
                $.ajax({
                    type: "POST",
                    url: "./ViewSearchAndManageCustomerReturnByChallanIdAjax/getPurchasedProductDetails.php",
                        ...
                        if (Data[0].FLAG == "OKK") {
                            ...
                            for (var i = 1; i < n; i++) {
                                ...
                                $("#purchasedtable tbody:last-child").append(
                                    ...
                                    //'<td id="baseprice'+ stockid +'">' + baseprice + '</td>'+
                                    '<td id="sellingprice'+ stockid +'">' + sellingprice + '</td>' +
                                    '<td style="width: 50px;"><input type="number" class="form-control availbill" value="0" onkeyup=" updateTable('+sellingprice+');" step="1" id="billingqty_' + stockid + '"></td>' +
                                    '<td style="width: 50px;"><input type="number" class="form-control availother" value="0" onkeyup="updateTable('+sellingprice+');" step="1" id="otherqty_' + stockid + '"></td>' +
            ...
            $("#savebtn").on('click', function(){
                ...
                var challanmetadata = {challanid: challanid};
                //var challanmetadata = {challanid: challanid};
                ...
                for (let i = 0; i < n; i++) {
                    ...
                    //var baseprice = $("#baseprice_"+tempstockid).val();
                ...
                $.ajax({
                    type: "POST",
                    url: './EditSearchAndManageCustomerReturnAjax/editChallanSaveChanges.php',
                    ...
                    error: function(Data){
                        console.log("Error In ./EditSearchAndManageCustomerReturnAjax/editChallanSaveChanges.php   Ajax Call");
        ...
        //     if (enterdvalue < 0) {
        //         swal('Quantity Cannot Be Zero Or Negative', '', 'warning').then(() => {
        //             ref.value = "";
        //             ref.focus();
        //             return;
        //         });
        ...
        //         swal('Quantity enetered is greater than the sold quantity', 'Available Qty : ' + avail, 'warning').then(() => {
        //             ref.value = "";
        //             ref.focus();
        //             return;
        //         });
        ...
        function updateTable(sellingprice) {
            var itr = stockIdsToBePurchased[Symbol.iterator]();
            var n = stockIdsToBePurchased.size;
            var totalprice = 0;
            for (let i = 0; i < n; i++) {
