<?php
    ...
    $query = "SELECT ChallanId, ChallanNo, CustomerName, ChallanDate , challanmst.RecStatus as RecStatus FROM challanmst JOIN tblcustomermst  WHERE challanmst.CustomerId = tblcustomermst.CustomerId and challanmst.CustomerId = {$customerid} ";
    ...
    if($result){
        ...
        if($no_of_results > 0){
            ...
            while($row = $result->fetch_assoc()){
                ...
                $obj = array('challanid'=> $challanid,'challandate'=> $challandate, 'challanno'=> $challanno, 'customername'=>$customername, 'recstatus'=>$recstatus);
                $dataToBeSent[] = $obj;
            }
